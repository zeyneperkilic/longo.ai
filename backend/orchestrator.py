...
def build_quiz_prompt(quiz_answers: Dict[str, Any], available_supplements: List[Dict[str, Any]] = None) -> List[Dict[str, str]]:
    ...
    system_prompt = (
        ...
        "8) KAYNAK EKLEME: Otomatik olarak kaynak link'leri, referans'lar veya citation'lar ekleme! "
        "9) Sadece kullanıcı özel olarak kaynak isterse o zaman ekle! "
...
def build_multiple_lab_prompt(tests_data: List[Dict[str, Any]], session_count: int, available_supplements: List[Dict[str, Any]] = None, user_profile: Dict[str, Any] = None) -> List[Dict[str, str]]:
 ...
 '    "daily_dose": "Günlük doz",\n'
    ...
    system_prompt = (
        ...
        "5) KAYNAK EKLEME: Otomatik olarak kaynak link'leri, referans'lar veya citation'lar ekleme! "
        "6) DİL: SADECE TÜRKÇE YANIT VER! İngilizce kelime, terim veya cümle kullanma!"
