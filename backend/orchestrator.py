...
def build_quiz_prompt(quiz_answers: Dict[str, Any], available_supplements: List[Dict[str, Any]] = None) -> List[Dict[str, str]]:
    ...
    schema = (
        ...
        '    "Alerji nedeniyle cikarilan supplementler"\n'
        "  ],\n"
        '  "allergy_alternatives": [\n'
        '    "Alerji durumunda onerilen alternatifler"\n'
        "  ],\n"
...
def build_multiple_lab_prompt(tests_data: List[Dict[str, Any]], session_count: int, available_supplements: List[Dict[str, Any]] = None, user_profile: Dict[str, Any] = None) -> List[Dict[str, str]]:
 ...
 '    "daily_dose": "Günlük doz",\n'
    ...
    system_prompt = (
        ...
        "5) Kullanıcıya hiçbir şekilde ihtiyacı olmayan supplement önerme! "
        "6) Kullanıcının yaşı, cinsiyeti, sağlık durumu, alerjileri, kullandığı ilaçlar dikkate al! "
        "7) Riskli durumlar varsa o supplement'i önerme! "
        "8) Sadece gerçekten gerekli olan supplementleri öner! "
        "9) KAYNAK EKLEME: Otomatik olarak kaynak link'leri, referans'lar veya citation'lar ekleme! "
        "10) DİL: SADECE TÜRKÇE YANIT VER! İngilizce kelime, terim veya cümle kullanma!"
